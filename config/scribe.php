...
return [
     ...
     */
    'title' => "Documentación api de prueba",

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'Aprendiendo a documentar un API.',
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'Puedes obtener el token de acceso iniciando sesión en tu cuenta desde la API.',
    ],
